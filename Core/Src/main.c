...
/*
 * ------------------------------------------------------------
 * FreeRTOS Workshop Base Code:
 * ------------------------------------------------------------
 *
 * Description: This code toggles a GPIO PIN and send a message
 * to systemview every 100 ms
...
#define DWT_CTRL	(*(volatile uint32_t*)0xE0001000)//used for systemview timestamp
